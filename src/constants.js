...
export const SkillsInfo = [
  ...
  export const experiences = [
    {
      ...
      company: "AI Rivals Infotech",
      date: "August 2025 - Present",
      desc: "Developed dynamic and scalable web applications using the Python full stack, handling both frontend and backend development. Collaborated with cross-functional teams to build responsive UI, implement RESTful APIs, and optimize application performance in an agile environment.",
      skills: [
        "HTML",
        "CSS",
        "JavaScript",
    ...
    },
    {
      ...
      desc: "Contributed to innovative projects as a Frontend Engineer, leading frontend development using technologies such as HTML, CSS, JavaScript, Bootstrap, and ReactJS. Worked closely with the team to deliver responsive, high-performance web applications and improve user experience through seamless integration of various technologies.",
      skills: [
        "ReactJS",
        "Redux",
        "JavaScript",
  ...
  export const education = [
    ...
    },
    {
      id: 3,
      img: vpsLogo,
      school: "Adarsh Secondary and Higher Secondary School, Umbare",
      date: "Apr 2015 - March 2020",
      grade: "91.80%",
      desc: "I completed my class 10 education from Adarsh Secondary and Higher Secondary School, Umbare, under the Maharashtra State board, where I studied Science with Math and also I was Topper of my school",
      degree: "SSC(X), Science and Math",
    },
  ];
  ...
  export const projects = [
    ...
    {
      id: 2,
      title: "Bhushan Mart ( E-Commerce platform)",
      description:
        ["Built a fully responsive e-commerce web application featuring product listing, search, and cart functionality using React.js and Tailwind CSS.",
        "Implemented component-based architecture with efficient state management to handle dynamic product data and smooth user interactions across all screen sizes."],
      image: movierecLogo,
      tags: ["React JS", "API", "HTML", "CSS", "JavaScript"],
      github: "https://github.com/Shivam-Gaikwad/Bhusahn_Mart",
      webapp: "https://bhusahn-mart-gea2.vercel.app/",
    },
    // {
    //   id: 3,
    ...
    },
    {
      ...
      description:
        [ "Developed an interactive social media analytics dashboard using React.js displaying key metrics such as followers,engagement, and post performance across multiple platforms.",
        "Built reusable React components with clean state management and a fully responsive layout ensuring smooth"],
      image: removebgLogo,
      tags: ["React JS", "API", "HTML", "CSS", "Javascript"],
      github: "https://github.com/Shivam-Gaikwad/social_media_dashboard",
